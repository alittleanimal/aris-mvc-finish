								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											...
											<c:forEach var="studentFailedGradeList" items="${studentFailedGradeList}" >			
											<tr>
												<td><c:out value="${studentFailedGradeList.cname}"></c:out></td>
												<td><c:out value="${studentFailedGradeList.testname}"></c:out></td>
												<td style="color: red"><c:out value="${studentFailedGradeList.grade}"></c:out></td>
											</tr>
											</c:forEach>
											
											<br>
											<c:forEach var="studentPassedGradeList" items="${studentPassedGradeList}" >			
											<tr>
												<td><c:out value="${studentPassedGradeList.cname}"></c:out></td>
												<td><c:out value="${studentPassedGradeList.testname}"></c:out></td>
												<td style="color: green"><c:out value="${studentPassedGradeList.grade}"></c:out></td>
											</tr>
											</c:forEach>
