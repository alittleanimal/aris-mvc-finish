					...
					<h3 class="page-title">成绩</h3>
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">考试列表<c:set var = "cno" value = "${cno}"/>     
									<spring:url var="createTest" value="/stock/view/createTestDetail/${cno}"/>
									<div style="float: right">
								    <a href="${createTest}" class="btn btn-primary">创建考试</a></div></h3>
								...
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											<c:forEach var="courseGradeList" items="${courseGradeList}" >			
											<tr>
												<spring:url var="viewUrl" value="/stock/view/gradeDetailTeacher/${courseGradeList.testid}" />
												<spring:url var="editUrl" value="/stock/view/endTest/${courseGradeList.testid}" />																																				
												<td><c:out value="${courseGradeList.cname}"></c:out></td>
												<td><c:out value="${courseGradeList.testname}"></c:out></td>
												<td><c:out value="${courseGradeList.time}"></c:out></td>
												<td>
								    ...
								    <spring:url var="gradeIndexUrl" value="/stock/view/gradeIndex"/>
