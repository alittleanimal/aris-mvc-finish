					...
					<ul class="nav">
						...
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="${userUrl}" class="active">个人信息</a></li>
						...
						<div class="clearfix">
							...
							<div class="profile-detail">
								<div class="profile-info">
									...
									<form:form action="${cofirmUrl}" method="post"
										cssClass="form-horizontal" modelAttribute="userUpdateForm">
										...
										<div class="control-group">
											<div class="controls">
												<button class="btn btn-success" type="submit" name="update">
													修改 &nbsp;<i class="icon-play icon-white icon"></i>
												</button>
											</div>
										</div>
