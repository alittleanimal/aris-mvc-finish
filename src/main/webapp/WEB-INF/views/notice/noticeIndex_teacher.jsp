			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="${noticeUrl}" class="active"><i class="lnr lnr-cog"></i> <span>公告</span></a></li>
					...
					<div class="col-md-6">
						...
						<div class="panel" align="left">
							<div class="panel-body">
								...
								<spring:url var="createNoticeUrl"
									value="/stock/view/createNotice" />
								<div style="float: right">
									<a href="${createNoticeUrl}" class="btn btn-primary">发布公告</a>
								</div>
							</div>
