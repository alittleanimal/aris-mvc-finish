			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="${fileUrl }" class="active"><i class="lnr lnr-dice"></i> <span>资料</span></a></li>
		...
		<div class="main" align="left">
			...
			<div class="main-content" align="left">
				<div class="container-fluid" align="left">
					<h3 class="page-title">资料</h3>
					<!-- TABLE STRIPED -->
					<div class="panel">
						<div class="panel-heading">
							<div style="font-size:20px ;float:left">资料管理</div>
							<div style="float:right">
								<form action="/aris/stock/upload" method="post" enctype="multipart/form-data">
									<div style="float:right" ><input class="btn btn-primary" type="submit" value="上 传"></div>
									<div style="float:right" ><input type="file" name="file"></div>
						...
						<div class="panel-body">
							<table class="table table-striped">
								...
								<tbody>
									<c:forEach var="me" items="${fileNameMap}">
										...
										<tr>
											<td><c:out value="${me.value}"></c:out></td>
							...
							<div style="text-align: center">
								<a href="${attendIndexUrl}" class="btn btn-primary">返回</a>
							</div>
						</div>
					</div>
					<!-- END TABLE STRIPED -->
