...
<head>
	<title>HomePage | Shanghai University Class Assistant</title>
	<meta charset="utf-8">
...
<body>
			...
			<div class="container-fluid">
				...
				<form class="navbar-form navbar-left">
					<div class="input-group">
						<input type="text" value="" class="form-control" placeholder="Search something...">
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">上海大学2017学年秋季学期</h3>
							<p class="panel-subtitle">Period: Sep 14, 2017 - Jan 21, 2018</p>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="weekly-summary text-right">
										<span class="number">89.7</span> <span class="percentage"><i class="fa fa-caret-up text-success"></i> 12%</span>
										<span class="info-label">平时成绩</span>
									</div>
									<div class="weekly-summary text-right">
										<span class="number">85.6</span> <span class="percentage"><i class="fa fa-caret-up text-success"></i> 23%</span>
										<span class="info-label">总评成绩</span>
									</div>
									<div class="weekly-summary text-right">
										<span class="number">27</span> <span class="percentage"><i class="fa fa-caret-down text-danger"></i> 8%</span>
									...
									<ul class="list-unstyled todo-list">
										<li>
											...
											<p>
												...
												<span class="short-description">Dynamically integrate client-centric technologies without cooperative resources.
												</span>
							...
							<div class="panel panel-scrolling">
								...
								<div class="panel-body">
									<ul class="list-unstyled activity-list">
										<li>
											<img src="/aris/resources/assets/img/user1.png" alt="Avatar" class="img-circle pull-left avatar">
											<p><a href="#">Michael</a> has achieved 80% of his completed tasks <span class="timestamp">20 minutes ago</span></p>
										</li>
										<li>
											<img src="/aris/resources/assets/img/user2.png" alt="Avatar" class="img-circle pull-left avatar">
											<p><a href="#">Daniel</a> has been added as a team member to project <a href="#">System Update</a> <span class="timestamp">Yesterday</span></p>
										</li>
										<li>
											<img src="/aris/resources/assets/img/user3.png" alt="Avatar" class="img-circle pull-left avatar">
											<p><a href="#">Martha</a> created a new heatmap view <a href="#">Landing Page</a> <span class="timestamp">2 days ago</span></p>
										</li>
										<li>
											<img src="/aris/resources/assets/img/user4.png" alt="Avatar" class="img-circle pull-left avatar">
											<p><a href="#">Jane</a> has completed all of the tasks <span class="timestamp">2 days ago</span></p>
										</li>
										<li>
											<img src="/aris/resources/assets/img/user5.png" alt="Avatar" class="img-circle pull-left avatar">
	...
	<script src="/aris/resources/assets/vendor/jquery.easy-pie-chart/jquery.easypiechart.min.js"></script>
