			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
							<a href="#subPages" data-toggle="collapse" class="active"><i class="lnr lnr-file-empty"></i> <span>个人信息</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
						...
						<div class="clearfix">
							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img src="/aris/resources/assets/img/user-medium.png" class="img-circle" alt="Avatar">
										<h3 class="name">littleAnimal</h3>
								...
								<div class="profile-detail">
									<div class="profile-info">
										...
										<ul class="list-unstyled list-justify">
											...
											<li>Mobile <span>18717955828</span></li>
											<li>Email <span>18717955828@163.com</span></li>
							...
							<div class="profile-right">
								...
								<div class="awards">
									...
									<div class="text-center"><a href="#" class="btn btn-default">查看所有奖励</a></div>
								</div>
								<!-- END AWARDS -->
								<!-- TABBED CONTENT -->
								<div class="custom-tabs-line tabs-line-bottom left-aligned">
									<ul class="nav" role="tablist">
										<li class="active"><a href="#tab-bottom-left1" role="tab" data-toggle="tab">最近活动</a></li>
										<li><a href="#tab-bottom-left2" role="tab" data-toggle="tab">课程 <span class="badge">7</span></a></li>
									</ul>
								</div>
											...
											<table class="table project-table">
												...
												<tbody>
													<tr>
														...
														<td><img src="/aris/resources/assets/img/user2.png" alt="Avatar" class="avatar img-circle"> <a href="#">Michael</a></td>
													...
													<tr>
														...
														<td><img src="/aris/resources/assets/img/user1.png" alt="Avatar" class="avatar img-circle"> <a href="#">Antonius</a></td>
													...
													<tr>
														...
														<td><img src="/aris/resources/assets/img/user5.png" alt="Avatar" class="avatar img-circle" /> <a href="#">Jason</a></td>
														<td><span class="label label-default">CLOSED</span></td>
													</tr>
												</tbody>
											</table>
