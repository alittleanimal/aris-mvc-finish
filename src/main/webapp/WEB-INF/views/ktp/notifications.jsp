...
<head>
	<title>Grade | Shanghai University Class Assistant</title>
	<meta charset="utf-8">
	...
	<link rel="stylesheet" href="/aris/resources/assets/vendor/toastr/toastr.min.css">
	<!-- MAIN CSS -->
...
<body>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="notifications.jsp" class="active"><i class="lnr lnr-alarm"></i> <span>成绩</span></a></li>
						<li>
	...
	<script src="/aris/resources/assets/vendor/toastr/toastr.min.js"></script>
