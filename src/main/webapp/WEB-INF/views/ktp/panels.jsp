...
<head>
	<title>Notices | Shanghai University Class Assistant</title>
	<meta charset="utf-8">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
							<a href="#subPages" data-toggle="collapse" class=""><i class="lnr lnr-file-empty"></i> <span>个人信息</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
						...
						<div class="col-md-8">
							...
							<div class="panel panel-headline">
								<div class="panel-heading">
									<h3 class="panel-title">夏季学期验收即将开始</h3>
									<p class="panel-subtitle">请各位同学准备好验收材料和报告</p>
								</div>
