...
<head>
	<title>Documents | Shanghai University Class Assistant</title>
	<meta charset="utf-8">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="tables.jsp" class="active"><i class="lnr lnr-dice"></i> <span>资料</span></a></li>
						...
						<div class="panel">
								<div class="panel-heading">
									...
									<s:form action="upload" method="post" enctype="multipart/form-data">
										...
										<s:file name="upload" label="上传的文件四"></s:file>
										<s:file name="upload" label="上传的文件五"></s:file>
