			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="${messageUrl}" class="active"><i
									...
									<ul>
										...
										<form:form id="courseInfoForm" class="form-horizontal"
											...
											<li style="list-style-type:none"><input id="semester"
												...
												style="height:60px;width:500px;"></li>
										</form:form>
									</ul>
									...
									<ul>									
										<li class="col-md-2 col-sm-4 col-xs-6"><span
											class="lnr lnr-user"></span> <span class="cssclass">lnr
												lnr-user</span></li>
										<li style="list-style-type:none"><input id="semester"
											name="semester" placeholder=${replyMessage.text} readonly="true"" type="text"
									...
									<ul>									
										<li class="col-md-2 col-sm-4 col-xs-6"><span
											class="lnr lnr-user"></span> <span class="cssclass">lnr
												lnr-user</span></li>
										<li style="list-style-type:none"><input id="semester"
											name="semester" placeholder=${noReplyMessage.text} readonly="true"" type="text"
											style="height:60px;width:500px;">
										</li>																	
									</ul>
								</div>
