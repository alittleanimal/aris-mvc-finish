			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="${messageUrl}" class="active"><i class="lnr lnr-linearicons"></i> <span>留言板</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
					...
					<div class="row">
							...
							<!-- CLASS2 -->
 							<c:forEach var="course" items="${courses}">						
								...
								<div class="panel-heading">
									...
									<spring:url var="messageDetailUrl" value="/stock/view/messageDetail/${course.cno}"/>									
									<div style="float: right">
								    <a href="${messageDetailUrl}" class="btn btn-info">进入留言板</a></div>
								</div>
								<br>
								<div class="panel-body">
									...
									<tr>
										...
										<i class="fa fa-info-circle"></i> 留言正在进行中
									</div>	
									</tr>
								</div>
							</div>
						...
						<div class="col-md-6">
							...
							<div class="panel" align="left">
								<div class="panel-body">
									<p class="demo-button">
										<div style="font-size:20px ;float:left">课堂留言板
									</div>
